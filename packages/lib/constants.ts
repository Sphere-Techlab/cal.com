...
export const LOGO = "/abroad-logo.png";
export const LOGO_ICON = "/abroad-icon.png";
export const AVATAR_FALLBACK = "/avatar.svg";
export const FAVICON_16 = "/favicon.ico";
export const FAVICON_32 = "/favicon.ico";
export const APPLE_TOUCH_ICON = "/apple-touch-icon.png";
export const MSTILE_ICON = "/mstile-150x150.png";
export const ANDROID_CHROME_ICON_192 = "/abroad-logo.png";
export const ANDROID_CHROME_ICON_256 = "/abroad-logo.png";
